...
namespace Razor_Blades_Tests
{
    ...
    public class Test_Blades_Ellipsis
    {
        ...
        public void Test_Ellipsis_DontSplitWords()
        {
            ...
            Assert.AreEqual(Ellipsis(message, 12), messageLess12 + Defaults.HtmlEllipsisCharacter, "should be truncated at previous word");
        }
        ...
        public void Test_Ellipsis_With_Umlauts()
        {
            ...
            Assert.AreEqual(msg5, Ellipsis(message, 5), "very short");
